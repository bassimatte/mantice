    ...
    for i, layer in enumerate(preset.get("layers", [])):
        layers_info.append({
            ...
            "name": layer.get("name", f"Layer {i}"),
                ...
                "pitch_semitones": layer.get("pitch_semitones", 0.0),
...
def _ui_params_to_preset(params: dict) -> dict:
    ...
    for l in params.get("layers", []):
        layers.append({
            ...
            "pitch_mode": l.get("pitch_mode", "resample"),
            "pitch_semitones": float(l.get("pitch_semitones", 0.0)),
            "sample_root_hz": l.get("sample_root_hz"),
